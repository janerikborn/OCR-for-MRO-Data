...
tesseract_cmd = r'C:\Users\Katharina\AppData\Local\Programs\Tesseract-OCR\tesseract.exe' # Pfad zur Lokal gespeicherten Pytesseract Datei - Installationstutorial: https://github.com/UB-Mannheim/tesseract/wiki Downloadlink (für Windows): https://github.com/UB-Mannheim/tesseract/wiki 
