...
# Pfad zur Tesseract-OCR-Programmdatei (Installationstutorial: https://github.com/UB-Mannheim/tesseract/wiki Downloadlink (für Windows): https://github.com/UB-Mannheim/tesseract/wiki)
